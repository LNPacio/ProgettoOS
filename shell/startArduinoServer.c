...
void route()
{
    ...
    {
        printf("HTTP/1.1 200 OK\r\n\r\n");
        printf("<!doctype html><html> <head> <meta charset=\"UTF-8\"><script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js\"></script></head><body><script type=\"text/javascript\">window.onload=function(){$(\"#sw\").prop(\"disabled\",true);$(\"#vn\").prop(\"disabled\",true);var selezione=\"set_name\"; an();};function an(){selezione=$(\"#command\").val(); if(selezione==\"set_pwm_name\" || selezione==\"set_adc_name\" || selezione==\"set_pwm_value\"){$(\"#sw\").prop(\"disabled\",false); $(\"#vn\").prop(\"disabled\",false); $(\"#sw\").css(\"visibility\", \"visible\"); $(\"#vn\").css(\"visibility\", \"visible\"); $(\"#a\").css(\"visibility\", \"visible\"); $(\"#b\").css(\"visibility\", \"visible\"); if(selezione==\"set_pwm_name\" || selezione==\"set_adc_name\"){$(\"#b\").html(\"Nome \");}else{$(\"#b\").html(\"Valore \");}}else{$(\"#sw\").prop(\"disabled\",true); $(\"#vn\").prop(\"disabled\",true); $(\"#sw\").css(\"visibility\", \"hidden\"); $(\"#vn\").css(\"visibility\", \"hidden\"); $(\"#a\").css(\"visibility\", \"hidden\"); $(\"#b\") .css(\"visibility\", \"hidden\");}}</script><form action=\"/resp\" method=\"post\"><br>Seleziona Comando:<select name=\"command\" id=\"command\" onchange=\"an()\"><option value=\"set_name\">Imposta il nome</option><option value=\"get_pwm\">Leggi valori PWM</option><option value=\"get_adc\">Leggi valori ADC</option><option value=\"set_pwm_name\">Imposta nomi PWM</option><option value=\"set_pwm_value\">Imposta valori PWM</option><option value=\"set_adc_name\">Imposta nomi ADC</option><option value=\"quit\">Chiudi</option></select><br><br>Nome<input type=\"text\" name=\"nome\"><br><a id=\"a\">Seleziona Canale:</a><select name=\"switch\" id=\"sw\"><option value=\"\">---</option><option value=\"switch_0\">0</option><option value=\"switch_1\">1</option><option value=\"switch_2\">2</option><option value=\"switch_3\">3</option><option value=\"switch_4\">4</option><option value=\"switch_5\">5</option><option value=\"switch_6\">6</option><option value=\"switch_7\">7</option></select><br><br><a id=\"b\">Valore o Nome</a><input type=\"text\" name=\"nome\" id=\"vn\"><br><br><button name=\"\" value=\"\">INVIO</button></form></body></html>");
        /*printf("<form action=\"/resp\" method=\"post\">");
